...
variable "amis" {
  description = "AMI image list for the selected for the configured region, see modules/aws/images"
  type = "list"
}
...
variable "host_count"  {
  description = "Number of hosts in this group"
  default = 1
}
...
variable "servers" {
  description = "List of servers for hosts in this group"
  type = "list"
}
